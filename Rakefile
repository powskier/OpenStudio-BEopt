...
namespace :test do
  ...
  task :regenerate_osms do
    ...
    osw_files = ["SFD_Multizone_2story_SL_UA_GRG_2Bed_2Bath_1Kitchen_Denver_GasWHTank.osw", "MF_2units_Multizone_2story_SL_UA_GRG_2Bed_2Bath_1Kitchen_Denver_GasWHTank.osw"]
