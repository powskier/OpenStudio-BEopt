...
class ResidentialGasGrillTest < MiniTest::Test
  ...
  def test_new_construction_gas
    ...
    expected_values = {"Annual_therm"=>30.3}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  
  def test_new_construction_mult_0_029
    args_hash = {}
    args_hash["base_energy"] = 30.0
    args_hash["mult"] = 0.029
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>0.88}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>30.0}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>15.15}
  ...
  def test_multifamily_new_construction
    ...
    expected_values = {"Annual_therm"=>208.0, "Space"=>args_hash["space"]}
  ...
  def _test_error(osm_file, args_hash)
    ...
    measure = ResidentialGasGrill.new
