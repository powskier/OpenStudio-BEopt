...
class ResidentialPoolHeaterGasTest < MiniTest::Test
  ...
  def test_new_construction_gas
    args_hash = {}
    args_hash["base_energy"] = 222.0
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>224.3}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  
  def test_new_construction_mult_0_014
    args_hash = {}
    args_hash["base_energy"] = 222.0
    args_hash["mult"] = 0.014
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>3.14}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>222.0}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>112.2}
  ...
  def test_single_family_attached_new_construction
    ...
    expected_values = {"Annual_therm"=>769.55}
  ...
  def test_multifamily_new_construction
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipment"=>num_units, "GasEquipmentDefinition"=>num_units, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>1539.1}
  ...
  def _test_error(osm_file, args_hash)
    ...
    measure = ResidentialPoolHeaterGas.new
