...
class ResidentialRefrigeratorTest < MiniTest::Test
  ...
  def test_new_construction_none1
    ...
    _test_measure(osm_geo, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 0, 1)
  end
  ...
  def test_new_construction_mult_1_05
    ...
    args_hash["fridge_E"] = 434.0
    args_hash["mult"] = 1.05
    args_hash["space"] = "Space: #{Constants.LivingSpace}"
    expected_num_del_objects = {}
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>1, "ElectricEquipment"=>1, "ScheduleRuleset"=>1}
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>1, "ElectricEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_kwh"=>434.0, "Space"=>args_hash["space"]}
    model = _test_measure(osm_geo, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 0, 1)
    args_hash = {}
