...
class ResidentialHotWaterHeaterTankElectricTest < MiniTest::Test
  ...
  def test_retrofit_replace_tank_electric_shw
    ...
    expected_num_del_objects = {"WaterHeaterMixed"=>1, "ScheduleConstant"=>1}
    expected_num_new_objects = {"WaterHeaterMixed"=>1, "ScheduleConstant"=>1}
    expected_values = {"TankVolume"=>50, "InputCapacity"=>4.5, "ThermalEfficiency"=>1.0, "TankUA"=>2.21, "Setpoint"=>args_hash["setpoint_temp"].to_f, "OnCycle"=>0, "OffCycle"=>0, "StorageTankSetpoint1"=>args_hash["setpoint_temp"].to_f, "StorageTankSetpoint2"=>args_hash["setpoint_temp"].to_f, "ThermalZone"=>args_hash["location"]}
