...
class ProcessConstructionsWallsExteriorWoodStudTest < MiniTest::Test
  ...
  def test_add_uninsulated_2x4_and_insulate_to_r13_gr2
    ...
    expected_num_new_objects = {"Material"=>1, "Construction"=>1}
    expected_values = {"LayerThickness"=>0.0889, "LayerConductivity"=>0.05694, "LayerDensity"=>161.7351, "LayerSpecificHeat"=>1179.4578, "LayerIndex"=>2, "SurfacesWithConstructions"=>8}
