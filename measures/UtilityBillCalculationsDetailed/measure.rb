...
class UtilityBillCalculationsDetailed < OpenStudio::Measure::ReportingMeasure
  ...
  def arguments()
    ...
    tariffs << "Utility ID A: Tariff 1"
    tariffs << "Utility ID A: Tariff 2"
    # TODO: list all 4500 tariffs
    arg = OpenStudio::Measure::OSArgument::makeChoiceArgument("tariffs", tariffs, false)
