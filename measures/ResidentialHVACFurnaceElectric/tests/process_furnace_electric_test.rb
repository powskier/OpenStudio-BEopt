...
class ProcessFurnaceElectricTest < MiniTest::Test
  ...
  def test_new_construction_afue_1
    ...
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>1, "AirLoopHVAC"=>1, "CoilHeatingElectric"=>1, "FanOnOff"=>1, "AirTerminalSingleDuctUncontrolled"=>1, "CoilCoolingDXMultiSpeedStageData"=>1, "CoilCoolingDXSingleSpeed"=>1}
    expected_values = {"Efficiency"=>1, "NominalCapacity"=>2*5861.42, "MaximumSupplyAirTemperature"=>48.88, "hvac_priority"=>1}
  ...
  def test_new_construction_fbsmt_afue_0_78
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>1, "AirLoopHVAC"=>1, "CoilHeatingElectric"=>1, "FanOnOff"=>1, "AirTerminalSingleDuctUncontrolled"=>2, "CoilCoolingDXMultiSpeedStageData"=>1, "CoilCoolingDXSingleSpeed"=>1}
    expected_values = {"Efficiency"=>1, "NominalCapacity"=>5861.42, "MaximumSupplyAirTemperature"=>48.88, "hvac_priority"=>1}
  ...
  def test_single_family_attached_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units, "AirLoopHVAC"=>num_units, "CoilHeatingElectric"=>num_units, "FanOnOff"=>num_units, "AirTerminalSingleDuctUncontrolled"=>num_units*2, "CoilCoolingDXMultiSpeedStageData"=>num_units, "CoilCoolingDXSingleSpeed"=>num_units}
    expected_values = {"Efficiency"=>1, "MaximumSupplyAirTemperature"=>48.88, "hvac_priority"=>1}
  ...
  def test_multifamily_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units, "AirLoopHVAC"=>num_units, "CoilHeatingElectric"=>num_units, "FanOnOff"=>num_units, "AirTerminalSingleDuctUncontrolled"=>num_units, "CoilCoolingDXMultiSpeedStageData"=>num_units, "CoilCoolingDXSingleSpeed"=>num_units}
    expected_values = {"Efficiency"=>1, "MaximumSupplyAirTemperature"=>48.88, "hvac_priority"=>1}
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_infos=0, num_warnings=0, debug=false)
    ...
    obj_type_exclusions = ["CurveCubic", "Node", "AirLoopHVACZoneMixer", "SizingSystem", "AirLoopHVACZoneSplitter", "ScheduleTypeLimits", "CurveExponent", "ScheduleConstant", "SizingPlant", "PipeAdiabatic", "ConnectorSplitter", "ModelObjectList", "ConnectorMixer", "CurveBiquadratic", "CurveQuadratic"]
