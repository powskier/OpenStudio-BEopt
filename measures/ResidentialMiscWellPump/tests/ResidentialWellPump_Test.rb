...
class ResidentialWellPumpTest < MiniTest::Test
  ...
  def test_new_construction_electric
    ...
    expected_values = {"Annual_kwh"=>404.2}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  
  def test_new_construction_mult_0_127
    args_hash = {}
    args_hash["base_energy"] = 400.0
    args_hash["mult"] = 0.127
    expected_num_del_objects = {}
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>1, "ElectricEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_kwh"=>51.3}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>1, "ElectricEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_kwh"=>400.0}
    _test_measure(osm_geo_beds, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>1, "ElectricEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_kwh"=>202.1}
  ...
  def test_single_family_attached_new_construction
    ...
    expected_values = {"Annual_kwh"=>1386.57}
  ...
  def _test_error(osm_file, args_hash)
    ...
    measure = ResidentialWellPump.new
